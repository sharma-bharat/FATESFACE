...
setwd(wd_src)
source('functions_FATESFACE_fatesoutv2.R')
source('lists_plotting_FATESFACE_fatesoutv2.R')
...
for(v in var_labs) {
  ...
  #   print(c)
    for(s in c('DUKE', 'ORNL' )) {
      ...
      plot_data <- 
        plot_modobs(l1, df_obs, df_obsse, labs=v, fvar=NULL, fsite=s, fco2='AMB',
                    sites=sites, years=years, caseidprefix=caseidprefix )
