...
# -----------------------------------
# Running this file
# python FixingDupicateDuke.py -file_ci ./DuplicateDukeDataCorrectIndexOnly.txt -path_data /Users/ud4/Documents/FACEMDS/MET_Data_Processing/Oren_2022_DUKE_Met/data/ -replace_file yes
...
parser. add_argument ('--file_correct_idx', 
                      '-file_ci',
                      help="provide the path of correct index txt e.g. (./DuplicateDukeDataCorrectIndexOnly.txt),
                      type = str, default = './DuplicateDukeDataCorrectIndexOnly.txt')
parser. add_argument ('--path_met_data', 
                      '-path_data',
                      help="provide the path to the parent dir of met data (~/data/),
                      type = str, default = '~/data/')
parser. add_argument ('--replace_existing_file', 
                      '-replace_file',
...
for file in all_files:
    ...
    if len(df_common_rows)> 0:
        ...
        df_tmp.loc[common_row_indices, selected_cols] = common_df_in_correct[selected_cols].values
        ...
        if replace_existing == 'yes':
            ...
            print(f"{file} is not updated with correct values. If you want the {file} to update, add flag '-replace_file yes'.")